...
<div class="container pb-6 pt-6">
    ...
    <div class="columns">
        ...
        <div class="column">
            <form class="mb-6 has-text-centred FormularioAjax" action="./php/producto_img_actualizar.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                <h4 class="title is-4 mb-6"><?php echo $datos['producto_nombre'];?></h4>
                <label>Foto o imagen del producto</label>
                ...
                <div class="file has-name is-horizontal is-justify-content-center mb-6">
                    <label class="file-label">
                        ...
                        <span class="file-name">JPG, PNG, JPEG, (3MB)</span>
                    </label>
                </div>
                <p class="has-text-centered">
