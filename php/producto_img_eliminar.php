<?php 
    ...
    /* cambiando permisos del directorio */
    chmod($img_dir, 0777);
    ...
    $actualizar_producto = $actualizar_producto -> prepare("UPDATE producto SET producto_foto WHERE producto_id=:id");
    ...
    if ($actualizar_producto->execute($marcadores)) {
        echo '
            <div class="notification is-info is-light">
                <strong>¡LA IMAGEN HA SIDO ELIMINADA!</strong><br>
                La imagen del producto ha sido eliminada exitosamente, pulse Acepter para recargar los cambios.
        ...
        echo '
            <div class="notification is-warning is-light">
                <strong>¡LA IMAGEN HA SIDO ELIMINADA!</strong><br>
                Ocurrieron algunos inconvenientes, sin embargo la imagen del producto fue eliminada, pulse Acepter para recargar los cambios.
