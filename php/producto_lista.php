<?php 
    ...
    /* campos necesarios para listar los productos */
    ...
    if (isset($busqueda) && $busqueda!="") {
        ...
        $consulta_datos = "SELECT $campos FROM producto INNER JOIN categoria ON producto.categoria_id=catgeoria.categoria_id INNER JOIN usuario ON producto.usuario_id=usuario.usuario_id ORDER BY producto_nombre ASC LIMIT $inicio.$registros";
                    ...
                    <article class="media">
                        ...
                        <div class="media-content">
                            ...
                            <div class="has-text-right">
                                <a href="index.php?vista=product_img&product_id_up='.$rows['producto_id'].'" class="button is-link is-rounded is-small">
                                Imagen
                                </a>
