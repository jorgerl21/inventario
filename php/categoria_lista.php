        ...
        ';
            ...
            if ($total>=1 && $pagina<=$Npaginas) {
                ...
                foreach ($datos as $rows) {
                    ...
                    <td>
                        <a href="index.php?vista=product_category&category_id='.$rows['cetegoria_id'].'"
                        class="button is-link is-rounded is-small">Ver productos</a>
                    </td>
                    <td>
                        <a href="index.php?vista=category_update&category_id='.$rows['cetegoria_id'].'"
                        class="button is-link is-rounded is-small">Actualizar</a>
                    </td>
                    <td>
                        <a href="'.$url.$pagina.'$category_id_del='.$rows['cetegoria_id'].'"
                        class="button is-link is-rounded is-small">Eliminar</a>
                    </td>
                    </tr>';
                    $contador++;
                        ...
                        <tr class="has-text-centered">
                            <td colspan="5">
                                <a href="'.$url.'1" class="button is-link is-rounded is-small mt-4 mb-4">
                                    Haga clic aqui para gresar el listado
                                </a>
                            </td>
                        </tr>
                        ';
                ...
                if ($total>0 && $pagina<=$Npaginas) {
                    $tabla.='<p class="has-text-right">Mostrando categorias<strong>'.$pag_inicio.'</strong>
